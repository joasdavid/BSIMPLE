...
Public Class MessageADT
    ...
    Public Overrides Function getSegmentCont(seg As String) As Integer
        ...
        ElseIf (seg = "OBX" And haveMSH > 0) Then
            Return haveOBX
        ElseIf (seg = "EVN" And haveEVN > 0) Then
            Return haveEVN
    ...
    Public Overrides Function Valide() As Boolean
        Return ValideMSH() And _
            ...
            ValideEVN()
    End Function
    Private Function ValideEVN() As Boolean
        If (haveEVN) Then
            If (EVN(1) = Nothing) Then
                '1-Recorded Date/Time
                Return False
            End If
        End If
        Return True
